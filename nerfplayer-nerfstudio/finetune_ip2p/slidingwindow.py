...
data_path = 'data/cat'
prompt = "turn the cat into a puppy"
ddim_inv_prompt = ""
selected_diffusion_step = 20
guidance_scale = 7.5
image_guidance_scale = 1.5
selected_num_train_timesteps = 1000
...
for batch_index in range(0, dataset_length, sequence_length - overlap_length):
    ...
    torchvision.utils.save_image(images, 'images_input_.png', nrow=sequence_length, padding=0, pad_value=1)
    torchvision.utils.save_image(images_cond, 'images_condition_.png', nrow=sequence_length, padding=0, pad_value=1)
