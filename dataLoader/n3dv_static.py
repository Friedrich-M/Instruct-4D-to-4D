...
class N3DVDataset(Dataset):
    ...
    def read_meta(self):
        ...
        self.image_paths = [f'{self.root_dir}/frames/{n}' for n in all_image_names]
        ...
        # See https://github.com/bmild/nerf/issues/34
        near_original = self.near_fars.min()*2.0
        ...
        self.render_path = get_spiral(self.poses, self.near_fars, rads_scale=0.2, zrate=-0.5, N_views=N_views)
